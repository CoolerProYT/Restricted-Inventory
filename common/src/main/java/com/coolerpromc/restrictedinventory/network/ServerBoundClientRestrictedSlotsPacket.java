...
public record ServerBoundClientRestrictedSlotsPacket(Map<Integer, Restriction> restrictedSlots) implements CustomPacket{
    ...
    public static ServerBoundClientRestrictedSlotsPacket decode(FriendlyByteBuf buf){
        return new ServerBoundClientRestrictedSlotsPacket(buf.readMap(FriendlyByteBuf::readInt, buf1 -> buf1.readJsonWithCodec(Restriction.CODEC)));
    }
